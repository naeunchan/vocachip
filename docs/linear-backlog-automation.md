...
- AI-generated issue scripts may add required dependencies (Expo/RN packages via `npx expo install`, others via `npm install`).
- Implementation/verification/PR-creation failures now stop immediately with a Linear comment.
