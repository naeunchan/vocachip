...
const translations: Record<Locale, Record<string, string>> = {
    ko: {
        ...
        "auth.login.subtitle": "Google/Apple로 로그인하거나, 게스트로 간단히 체험해보세요.",
        "auth.signup.subtitle": "소셜 계정으로 바로 가입하고 모든 기능을 이용해보세요.",
        "auth.login.primary": "로그인",
        "auth.signup.primary": "회원가입",
        "auth.social.google": "Google로 로그인",
        "auth.social.apple": "Apple로 로그인",
        "auth.social.googleSignup": "Google로 회원가입",
        "auth.social.appleSignup": "Apple로 회원가입",
        "auth.social.loading": "소셜 계정으로 연결 중...",
    ...
    en: {
        ...
        "auth.login.subtitle": "Use Google/Apple to sign in, or explore as a guest.",
        "auth.signup.subtitle": "Sign up with your social account to unlock every feature.",
        "auth.login.primary": "Log in",
        "auth.signup.primary": "Sign up",
        "auth.social.google": "Log in with Google",
        "auth.social.apple": "Log in with Apple",
        "auth.social.googleSignup": "Sign up with Google",
        "auth.social.appleSignup": "Sign up with Apple",
        "auth.social.loading": "Connecting to provider...",
